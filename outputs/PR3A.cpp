...
for (int x3 = x2; x3 < CONT_SZ; ++x3) {
for (int x4 = x3; x4 < CONT_SZ; ++x4) {
other_cont_degree5[x0][x1][x2][x3][x4] = ((other_cont_sum1[x0] * other_cont_sum1[x1] * other_cont_sum1[x2] * other_cont_sum1[x3] * other_cont_sum1[x4]));
}
}
}
}
...
for (int x4 = x3; x4 < CONT_SZ; ++x4) {
for (int x5 = x4; x5 < CONT_SZ; ++x5) {
other_cont_degree6[x0][x1][x2][x3][x4][x5] = ((other_cont_sum1[x0] * other_cont_sum1[x1] * other_cont_sum1[x2] * other_cont_sum1[x3] * other_cont_sum1[x4] * other_cont_sum1[x5]));
}
}
}
}
...
r_cont_degree5[x0][x1][x2][x3][x4] += (cont_degree5[x0][x1][x2][x3][x4]);

r_cont_degree5[x0][x1][x2][x3][x4] += (other_cont_degree5[x0][x1][x2][x3][x4]);
...
r_cont_degree6[x0][x1][x2][x3][x4][x5] += (cont_degree6[x0][x1][x2][x3][x4][x5]);

r_cont_degree6[x0][x1][x2][x3][x4][x5] += (other_cont_degree6[x0][x1][x2][x3][x4][x5]);
