...
"builtin.module"() ({
  ...
  "func.func"() ({
    ...
    %Ii32 = "func.call"(%argv3) {callee = @atoi} : (!llvm.ptr<i8>) -> i32
...
%orFlag61 = "arith.ori"(%orFlag49, %andFlag59) : (i1, i1) -> i1
...
%last70 = "memref.load"(%B, %const_val_0, %const_val_0, %const_val_0) : (memref<?x?x?xf64>, index, index, index) -> f64
