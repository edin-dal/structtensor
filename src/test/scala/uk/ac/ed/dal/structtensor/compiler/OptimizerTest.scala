...
class OptimizerTest
  ...
  it should "replace equal variables in a rule" in {
    ...
    actual shouldBe Rule(
      Access("A", List(Variable("i")), Tensor),
      SoP(
        List(
          Prod(
            List(
              Access("B", List(Variable("i"), Variable("i")), Tensor),
              Access("C", List(Variable("i"), Variable("i")), Tensor),
              Access("D", List(Variable("p"), Variable("q")), Tensor)
            )
          ),
          Prod(
            List(
              Access("B", List(Variable("i"), Variable("i")), Tensor),
              Access("C", List(Variable("p"), Variable("p")), Tensor)
            )
          )
        )
      )
