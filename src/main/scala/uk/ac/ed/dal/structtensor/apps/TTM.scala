...
object TTM {
  def ttm(structure: String, mode: Int = 0, sparse: Boolean = false, codeLang: String = "CPP", codeMotion: Boolean = true, sturOpt: Boolean = false) = {
...
"""
    val c2 = ttm(structure, 1, sparse, codeMotion=codeMotion, sturOpt=sturOpt)
    val c3 =
s"""
...
"""
    ...
    val c8 = ttm(structure, 1, sparse, "MLIR", sturOpt=sturOpt)
    val cerr_load = s"""
